...
public class PhotoController {
    ...
    public String uploadPhoto(@ModelAttribute PhotoUploadModel photoUpload, BindingResult result, ModelMap model) throws IOException {
    ...
    public String uploadPhotoForm(ModelMap model) {
        model.addAttribute("photoUpload", new PhotoUploadModel());
        return "upload_form";
    }
